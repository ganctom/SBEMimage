    ...
    def _vp_place_grid(self, grid_index,
        ...
        if show_grid and self.gm[grid_index].use_slice_shift:
            ...
            if n_passes > 1 and active_tiles:
                ...
                dx = self.gm[grid_index].overlap + self.gm[grid_index].row_shift if self.gm[grid_index].row_shift > 0 else self.gm[grid_index].overlap
                dy = self.gm[grid_index].overlap
